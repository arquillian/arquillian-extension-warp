 ...
 *
 * <p><strong>Thread-safety:</strong>This class is mutable and not thread safe. It should be used with caution and
 * configured in JAX-RS to be used in per-request execution mode.</p>
 *

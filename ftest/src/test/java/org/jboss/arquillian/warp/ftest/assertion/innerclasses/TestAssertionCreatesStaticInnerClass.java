 ...
 */
package org.jboss.arquillian.warp.ftest.assertion.innerclasses;
...
@WarpTest
@RunAsClient
public class TestAssertionCreatesStaticInnerClass {
        ...
        Warp
            ...
            .verify(new ServerAssertion() {
                ...
                public void afterServlet() {
                    new ClassReferencedFromAssertion();
                }
            }
        );
    }

    public static class ClassReferencedFromAssertion {
    }
}

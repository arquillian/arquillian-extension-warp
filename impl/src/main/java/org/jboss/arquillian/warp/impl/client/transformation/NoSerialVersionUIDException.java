...
public class NoSerialVersionUIDException extends RuntimeException {
    ...
    public NoSerialVersionUIDException(String message, Throwable cause) {
        super(message, cause);
    }

    public NoSerialVersionUIDException(String message) {
        super(message);
    }

    public NoSerialVersionUIDException(Throwable cause) {
        super(cause);
    }
}

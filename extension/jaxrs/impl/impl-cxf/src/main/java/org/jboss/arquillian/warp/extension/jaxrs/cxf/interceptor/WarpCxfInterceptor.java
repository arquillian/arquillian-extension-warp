 ...
 *
 * <p><strong>Thread-safety:</strong>This class is muttable and not thread safe. It should be used with caution and all
 * cases it should be configured to be used in JAX-RS in per-request mode.</p>
 *

...
/**
 * The exception thrown when delegated request processing fails
 *
 * @author Lukas Fryc
 */
public class RequestDelegationException extends RuntimeException {
    ...
    public RequestDelegationException(String message, Throwable cause) {
        super(message, cause);
    }

    public RequestDelegationException(String message) {
        super(message);
    }
